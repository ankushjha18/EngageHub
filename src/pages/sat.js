 ...
 { name: 'Parent of Accepted Student, Dubai',
  ...
  const researchSteps = [
    ...
    },
    {
      ...
      description: "Our comprehensive curriculum, designed to include custom strategies, guides, books, homework sets, and tests, can help students crack the SAT and achieve a high score.",
  ...
  const features = [
    {
      ...
      description: 'Access thousands of practice questions, detailed explanations, and study guides covering all SAT sections.'
    },
    {
      icon: <FaBullseye />,
        ...
        <section ref={ctaRef} className="cta section">
          <div className="container">
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="cta-title">Ready to Boost Your SAT Score?</h2>
              <p className="cta-subtitle">
                Join thousands of students who have achieved their dream scores. 
                Start your journey to success today with our proven SAT prep program.
              </p>
