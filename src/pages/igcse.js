  ...
  const researchSteps = [
    {
      ...
      description: "EnageHub specializes in one-on-one teaching, empowering students with online personalized IGCSE prep",
    ...
    },
    {
      ...
      description: "At EngageHub, we pair you with an experienced mentor to guide you through the IGCSE prep process.",
    },
    {
      step: 6,
      title: "Grade Improvement: IGCSE Ready",
      description: "The AP Guru course ensures that each student is IGCSE ready regardless of the initial academic level at which they stand.",
    }
  ];
  ...
  const features = [
    {
      ...
      description: 'Access thousands of practice questions, detailed explanations, and study guides covering all IGCSE sections.'
    },
    {
      icon: <FaBullseye />,
...
/*  const pricingPlans = [
      ...
      <div className="sat-page">
            ...
            <div className="hero-grid">
              ...
              >
                <h1 className="hero-title">
                  Master the IGCSE with
                  <span className="highlight"> Expert Guidance</span>
                </h1>
                <p className="hero-subtitle">
                  Achieve your dream score with our comprehensive IGCSE prep program. 
        ...
        <section ref={featuresRef} className="features section">
          <div className="container">
            ...
            >
              <h2 className="section-title">Why Choose Our IGCSE Prep?</h2>
 ...
 {/* how it works */}
        ...
        <div className="research-section-header">
          <h2 className="research-section-title"> Everything You Need To Succeed On Your IGCSE</h2>
        ...
        <section ref={ctaRef} className="cta section">
          <div className="container">
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="cta-title">Ready to Boost Your IGCSE Score?</h2>
              <p className="cta-subtitle">
                Join thousands of students who have achieved their dream scores. 
                Start your journey to success today with our proven IGCSE prep program.
              </p>
