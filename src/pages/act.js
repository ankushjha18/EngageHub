  ...
  const features = [
    {
      ...
      description: 'Access thousands of practice questions, detailed explanations, and study guides covering all ACT sections.'
    },
    {
      icon: <FaBullseye />,
      ...
      <div className="sat-page">
            ...
            <div className="hero-grid">
              ...
              >
                ...
                <p className="hero-subtitle">
                  Achieve your dream score with our comprehensive ACT prep program. 
        ...
        <section ref={featuresRef} className="features section">
          <div className="container">
            ...
            >
              <h2 className="section-title">Why Choose Our ACT Prep?</h2>
        ...
        <section ref={ctaRef} className="cta section">
          <div className="container">
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="cta-title">Ready to Boost Your ACT Score?</h2>
              <p className="cta-subtitle">
                Join thousands of students who have achieved their dream scores. 
                Start your journey to success today with our proven ACT prep program.
              </p>
