      ...
      <section ref={featuresRef} className="features section">
        <div className="container">
          <motion.div className="section-header" initial={{ opacity: 0, y: 30 }} animate={isFeaturesInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
           ...
           At EngageHub, we are committed to delivering world-class educational guidance and support. Through our strategic collaborations we combine expertise, innovation, and global best practices to provide unmatched value to our students.
           <br/><p><b>Our students benefit from: </b></p>
            </p>
          </motion.div>
