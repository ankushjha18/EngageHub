      ...
      <div className="sat-page">
            ...
            <div className="hero-grid">
              ...
              >
                <h1 className="hero-title">
                  Master the A-LEVEL with
                  <span className="highlight"> Expert Guidance</span>
                </h1>
                <p className="hero-subtitle">
                  Achieve your dream score with our comprehensive A-LEVEL prep program. 
              ...
              >
                <div className="score-card">
                  ...
                  <p>"Best A-LEVEL prep program I've ever used!"</p>
                </div>
              </motion.div>
            </div>
          </div>
        ...
        <section ref={featuresRef} className="features section">
          <div className="container">
            ...
            >
              <h2 className="section-title">Why Choose Our A-LEVEL Prep?</h2>
        ...
        <section ref={ctaRef} className="cta section">
          <div className="container">
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="cta-title">Ready to Boost Your A-LEVEL Score?</h2>
              <p className="cta-subtitle">
                Join thousands of students who have achieved their dream scores. 
                Start your journey to success today with our proven A-LEVEL prep program.
              </p>
