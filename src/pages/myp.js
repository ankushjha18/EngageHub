  ...
  const researchSteps = [
    {
      ...
      description: "EnageHub specializes in one-on-one teaching, empowering students with online personalized MYP prep",
    ...
    },
    {
      ...
      description: "At EngageHub, we pair you with an experienced mentor to guide you through the MYP prep process.",
    },
  ];
  ...
  const features = [
    {
      ...
      description: 'Access thousands of practice questions, detailed explanations, and study guides covering all MYP sections.'
    },
    {
      icon: <FaBullseye />,
      ...
      <div className="sat-page">
            ...
            <div className="hero-grid">
              ...
              >
                ...
                <p className="hero-subtitle">
                  Achieve your dream score with our comprehensive MYP prep program. 
              ...
              >
                <div className="score-card">
                  ...
                  <p>"Best MYP prep program I've ever used!"</p>
                </div>
              </motion.div>
            </div>
          </div>
        ...
        <section ref={featuresRef} className="features section">
          <div className="container">
            ...
            >
              <h2 className="section-title">Why Choose Our MYP Prep?</h2>
       ...
       <section className="research-section research-process">
        <div className="research-section-header">
          <h2 className="research-section-title"> Everything You Need To Succeed On Your MYP</h2>
        ...
        <section ref={ctaRef} className="cta section">
          <div className="container">
            <motion.div 
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="cta-title">Ready to Boost Your MYP Score?</h2>
              <p className="cta-subtitle">
                Join thousands of students who have achieved their dream scores. 
                Start your journey to success today with our proven MYP prep program.
              </p>
