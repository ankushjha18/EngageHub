...
/*  const testimonials = [
    {
      name: "Ananya Gupta",
      feedback:
        "The consulting guided me step-by-step for my master's application in the US. I received 3 admits with scholarships!",
    },
    {
      name: "Rohan Mehta",
      feedback:
    ...
    <div className="consultancy-page">
      ...
      <section className="consultancy-hero">
        <div className="hero-content">
          ...
          University Education <span className="highlight">Consulting</span> for
          Top Universities
          </h1>
         ...
         <a href="/contact"> <button className="cta-btn">Book a Free Consulting</button> </a>
        </div>
      </section>
...
EngageHub is one of the leading education consulting  and across the UAE providing overseas education consulting services in UAE for the progress of the students and their bright future. Our handpicked professional tutors, educational counsellors, and counsellors ensure that each student, who reaches out to us, succeeds in the path of life by choosing the right field of education and enrolment to the elite universities around the world.
              </p>
             {/*} <p className="ceo-message-text">
 ...
 <section className="ucas-section">
    ...
    <article className="ucas-card1">
      <h2>EngageHub Overseas Education Consulting</h2>
      <p>
    ...
    <article className="ucas-card3">
      ...
      <p>
      EngageHub extends comprehensive assistance in education consulting . When it comes to overseas education consulting, it begins with the selection
    ...
    <article className="ucas-card4">
      ...
      <p>
      As an abroad education consulting , we do not just provide a list of universities. On the other hand, we will examine the student’s 
  ...
  <div className="steps-container">
    {[
      {
        num: "1",
        title: "Initial Consulting & Profile Evaluation",
