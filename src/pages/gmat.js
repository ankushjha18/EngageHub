  ...
  const researchSteps = [
    {
      ...
      description: "EnageHub specializes in one-on-one teaching, empowering students with online personalized GMAT prep",
    ...
    },
    {
      ...
      description: "At EngageHub, we pair you with an experienced mentor to guide you through the GMAT prep process.",
    }
  ];
...
/*  const pricingPlans = [
 ...
 {/* how it works */}
        ...
        <div className="research-section-header">
          <h2 className="research-section-title"> Everything You Need To Succeed On Your GMAT</h2>
